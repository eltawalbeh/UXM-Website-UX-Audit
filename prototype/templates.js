...
function render() {
  ...
  root.className = '';
  root.innerHTML = `<div class="shell"><header class="top"><a class="brand" href="/">UXM<span>Audit</span></a><div class="top-actions"><a class="button alt" href="/operations.html">Operations</a><a class="button alt" href="/">Audit workspace</a></div></header><main class="operations-main">
    ...
    ${state.createdAudit ? `<section class="notice"><b>Audit created.</b> ${state.createdAudit.assessments ? Object.keys(state.createdAudit.assessments).length : 0} checkpoints are ready for manual assessment. <a class="button alt" href="/?audit=${encodeURIComponent(state.createdAudit.id)}">Open audit</a></section>` : ''}
